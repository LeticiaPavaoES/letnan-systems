    ...
    return (
        <section className="bg-white py-12">
            <div className="container mx-auto px-4 py-8">
                ...
                <h2 className="text-2xl font-semibold text-gray-500 mb-4">Nossos Serviços</h2>
                <p className="mb-4 text-gray-500">
                ...
                <h2 className="text-2xl font-semibold text-gray-500 mb-4">Segurança de Dados e Sistemas</h2>
                ...
                <h2 className="text-2xl font-semibold text-gray-500 mb-4">Infraestrutura de Rede e Internet</h2>
                <p className="text-gray-500 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-500 mb-4">Comunicação Transparente com Clientes</h2>
                <p className="text-gray-500 mb-4">
